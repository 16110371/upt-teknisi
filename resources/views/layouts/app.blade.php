                    ...
                    <div style="padding:16px;">
                        <div x-show="!unit">
                            ...
                            <div x-show="error" style="margin-top:12px; background:#fef2f2; border:1px solid #fecaca; border-radius:12px; padding:16px; text-align:center;">
                                ...
                                <button @click="error = ''; startScanner()" style="margin-top:12px; padding:8px 16px; background:#dc2626; color:white; border:none; border-radius:8px; font-size:12px; font-weight:600; cursor:pointer;">🔄 Coba Lagi</button>
                            </div>
                        </div>
                        <div x-show="unit" style="display:none;">
                            ...
                            <div style="display:flex; gap:8px;">
                                <a :href="'/unit/' + unit?.code" style="flex:1; background:#1e293b; color:white; padding:12px 16px; border-radius:12px; font-size:13px; font-weight:600; text-align:center; text-decoration:none;">🔗 Lihat Detail & Lapor</a>
                                <button @click="unit = null; startScanner()" style="flex:1; background:#e5e7eb; color:#374151; padding:12px 16px; border-radius:12px; font-size:13px; font-weight:600; border:none; cursor:pointer;">📷 Scan Lagi</button>
                            </div>
                        </div>
                    </div>
                </div>
